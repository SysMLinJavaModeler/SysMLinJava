...
/**
 * Enumeration of the colors, including their RGB values, that can be used for
 * objects in the area display
 * 
 * @author ModelerOne
 *
 */
public enum ColorEnum
{
	 ...
	 * 10px 0 0"></div>
	 */
	ALICEBLUE(0.9411765f, 0.972549f, 1.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	ANTIQUEWHITE(0.98039216f, 0.92156863f, 0.84313726f),
	 ...
	 * 10px 0 0"></div>
	 */
	AQUAMARINE(0.49803922f, 1.0f, 0.83137256f),
	 ...
	 * 10px 0 0"></div>
	 */
	BEIGE(0.9607843f, 0.9607843f, 0.8627451f),
	 ...
	 * 10px 0 0"></div>
	 */
	BISQUE(1.0f, 0.89411765f, 0.76862746f),
	 ...
	 * 10px 0 0"></div>
	 */
	BLANCHEDALMOND(1.0f, 0.92156863f, 0.8039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	BLUEVIOLET(0.5411765f, 0.16862746f, 0.8862745f),
	 ...
	 * 10px 0 0"></div>
	 */
	BROWN(0.64705884f, 0.16470589f, 0.16470589f),
	 ...
	 * 10px 0 0"></div>
	 */
	BURLYWOOD(0.87058824f, 0.72156864f, 0.5294118f),
	 ...
	 * 10px 0 0"></div>
	 */
	CADETBLUE(0.37254903f, 0.61960787f, 0.627451f),
	 ...
	 * 10px 0 0"></div>
	 */
	CHARTREUSE(0.49803922f, 1.0f, 0.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	CHOCOLATE(0.8235294f, 0.4117647f, 0.11764706f),
	 ...
	 * 10px 0 0"></div>
	 */
	CORAL(1.0f, 0.49803922f, 0.3137255f),
	 ...
	 * 10px 0 0"></div>
	 */
	CORNFLOWERBLUE(0.39215687f, 0.58431375f, 0.92941177f),
	 ...
	 * 10px 0 0"></div>
	 */
	CORNSILK(1.0f, 0.972549f, 0.8627451f),
	 ...
	 * 10px 0 0"></div>
	 */
	CRIMSON(0.8627451f, 0.078431375f, 0.23529412f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKBLUE(0.0f, 0.0f, 0.54509807f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKCYAN(0.0f, 0.54509807f, 0.54509807f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKGOLDENROD(0.72156864f, 0.5254902f, 0.043137256f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKGREEN(0.0f, 0.39215687f, 0.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKKHAKI(0.7411765f, 0.7176471f, 0.41960785f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKMAGENTA(0.54509807f, 0.0f, 0.54509807f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKOLIVEGREEN(0.33333334f, 0.41960785f, 0.18431373f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKORANGE(1.0f, 0.54901963f, 0.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKORCHID(0.6f, 0.19607843f, 0.8f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKSALMON(0.9137255f, 0.5882353f, 0.47843137f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKSEAGREEN(0.56078434f, 0.7372549f, 0.56078434f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKSLATEBLUE(0.28235295f, 0.23921569f, 0.54509807f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKSLATEGRAY(0.18431373f, 0.30980393f, 0.30980393f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKTURQUOISE(0.0f, 0.80784315f, 0.81960785f),
	 ...
	 * 10px 0 0"></div>
	 */
	DARKVIOLET(0.5803922f, 0.0f, 0.827451f),
	 ...
	 * 10px 0 0"></div>
	 */
	DEEPPINK(1.0f, 0.078431375f, 0.5764706f),
	 ...
	 * 10px 0 0"></div>
	 */
	DEEPSKYBLUE(0.0f, 0.7490196f, 1.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	DIMGRAY(0.4117647f, 0.4117647f, 0.4117647f),
	 ...
	 * 10px 0 0"></div>
	 */
	DODGERBLUE(0.11764706f, 0.5647059f, 1.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	FIREBRICK(0.69803923f, 0.13333334f, 0.13333334f),
	 ...
	 * 10px 0 0"></div>
	 */
	FLORALWHITE(1.0f, 0.98039216f, 0.9411765f),
	 ...
	 * 10px 0 0"></div>
	 */
	FORESTGREEN(0.13333334f, 0.54509807f, 0.13333334f),
	 ...
	 * 10px 0 0"></div>
	 */
	GAINSBORO(0.8627451f, 0.8627451f, 0.8627451f),
	 ...
	 * 10px 0 0"></div>
	 */
	GHOSTWHITE(0.972549f, 0.972549f, 1.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	GOLDENROD(0.85490197f, 0.64705884f, 0.1254902f),
	 ...
	 * 10px 0 0"></div>
	 */
	GRAY(0.5019608f, 0.5019608f, 0.5019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	GREENYELLOW(0.6784314f, 1.0f, 0.18431373f),
	 ...
	 * 10px 0 0"></div>
	 */
	HONEYDEW(0.9411765f, 1.0f, 0.9411765f),
	 ...
	 * 10px 0 0"></div>
	 */
	HOTPINK(1.0f, 0.4117647f, 0.7058824f),
	 ...
	 * 10px 0 0"></div>
	 */
	INDIANRED(0.8039216f, 0.36078432f, 0.36078432f),
	 ...
	 * 10px 0 0"></div>
	 */
	INDIGO(0.29411766f, 0.0f, 0.50980395f),
	 ...
	 * 10px 0 0"></div>
	 */
	KHAKI(0.9411765f, 0.9019608f, 0.54901963f),
	 ...
	 * 10px 0 0"></div>
	 */
	LAVENDER(0.9019608f, 0.9019608f, 0.98039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	LAVENDERBLUSH(1.0f, 0.9411765f, 0.9607843f),
	 ...
	 * 10px 0 0"></div>
	 */
	LAWNGREEN(0.4862745f, 0.9882353f, 0.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	LEMONCHIFFON(1.0f, 0.98039216f, 0.8039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTBLUE(0.6784314f, 0.84705883f, 0.9019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTCORAL(0.9411765f, 0.5019608f, 0.5019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTCYAN(0.8784314f, 1.0f, 1.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTGOLDENRODYELLOW(0.98039216f, 0.98039216f, 0.8235294f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTGREEN(0.5647059f, 0.93333334f, 0.5647059f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTPINK(1.0f, 0.7137255f, 0.75686276f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTSALMON(1.0f, 0.627451f, 0.47843137f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTSEAGREEN(0.1254902f, 0.69803923f, 0.6666667f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTSKYBLUE(0.5294118f, 0.80784315f, 0.98039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTSLATEGRAY(0.46666667f, 0.53333336f, 0.6f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTSTEELBLUE(0.6901961f, 0.76862746f, 0.87058824f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIGHTYELLOW(1.0f, 1.0f, 0.8784314f),
	 ...
	 * 10px 0 0"></div>
	 */
	LIMEGREEN(0.19607843f, 0.8039216f, 0.19607843f),
	 ...
	 * 10px 0 0"></div>
	 */
	LINEN(0.98039216f, 0.9411765f, 0.9019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMAQUAMARINE(0.4f, 0.8039216f, 0.6666667f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMBLUE(0.0f, 0.0f, 0.8039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMORCHID(0.7294118f, 0.33333334f, 0.827451f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMPURPLE(0.5764706f, 0.4392157f, 0.85882354f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMSEAGREEN(0.23529412f, 0.7019608f, 0.44313726f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMSLATEBLUE(0.48235294f, 0.40784314f, 0.93333334f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMSPRINGGREEN(0.0f, 0.98039216f, 0.6039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMTURQUOISE(0.28235295f, 0.81960785f, 0.8f),
	 ...
	 * 10px 0 0"></div>
	 */
	MEDIUMVIOLETRED(0.78039217f, 0.08235294f, 0.52156866f),
	 ...
	 * 10px 0 0"></div>
	 */
	MIDNIGHTBLUE(0.09803922f, 0.09803922f, 0.4392157f),
	 ...
	 * 10px 0 0"></div>
	 */
	MINTCREAM(0.9607843f, 1.0f, 0.98039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	MISTYROSE(1.0f, 0.89411765f, 0.88235295f),
	 ...
	 * 10px 0 0"></div>
	 */
	MOCCASIN(1.0f, 0.89411765f, 0.70980394f),
	 ...
	 * 10px 0 0"></div>
	 */
	NAVAJOWHITE(1.0f, 0.87058824f, 0.6784314f),
	 ...
	 * 10px 0 0"></div>
	 */
	OLDLACE(0.99215686f, 0.9607843f, 0.9019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	OLIVE(0.5019608f, 0.5019608f, 0.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	OLIVEDRAB(0.41960785f, 0.5568628f, 0.13725491f),
	 ...
	 * 10px 0 0"></div>
	 */
	ORANGERED(1.0f, 0.27058825f, 0.0f),
	 ...
	 * 10px 0 0"></div>
	 */
	ORCHID(0.85490197f, 0.4392157f, 0.8392157f),
	 ...
	 * 10px 0 0"></div>
	 */
	PALEGOLDENROD(0.93333334f, 0.9098039f, 0.6666667f),
	 ...
	 * 10px 0 0"></div>
	 */
	PALEGREEN(0.59607846f, 0.9843137f, 0.59607846f),
	 ...
	 * 10px 0 0"></div>
	 */
	PALETURQUOISE(0.6862745f, 0.93333334f, 0.93333334f),
	 ...
	 * 10px 0 0"></div>
	 */
	PALEVIOLETRED(0.85882354f, 0.4392157f, 0.5764706f),
	 ...
	 * 10px 0 0"></div>
	 */
	PAPAYAWHIP(1.0f, 0.9372549f, 0.8352941f),
	 ...
	 * 10px 0 0"></div>
	 */
	PEACHPUFF(1.0f, 0.85490197f, 0.7254902f),
	 ...
	 * 10px 0 0"></div>
	 */
	PERU(0.8039216f, 0.52156866f, 0.24705882f),
	 ...
	 * 10px 0 0"></div>
	 */
	PINK(1.0f, 0.7529412f, 0.79607844f),
	 ...
	 * 10px 0 0"></div>
	 */
	PLUM(0.8666667f, 0.627451f, 0.8666667f),
	 ...
	 * 10px 0 0"></div>
	 */
	POWDERBLUE(0.6901961f, 0.8784314f, 0.9019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	PURPLE(0.5019608f, 0.0f, 0.5019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	ROSYBROWN(0.7372549f, 0.56078434f, 0.56078434f),
	 ...
	 * 10px 0 0"></div>
	 */
	ROYALBLUE(0.25490198f, 0.4117647f, 0.88235295f),
	 ...
	 * 10px 0 0"></div>
	 */
	SADDLEBROWN(0.54509807f, 0.27058825f, 0.07450981f),
	 ...
	 * 10px 0 0"></div>
	 */
	SALMON(0.98039216f, 0.5019608f, 0.44705883f),
	 ...
	 * 10px 0 0"></div>
	 */
	SANDYBROWN(0.95686275f, 0.6431373f, 0.3764706f),
	 ...
	 * 10px 0 0"></div>
	 */
	SEAGREEN(0.18039216f, 0.54509807f, 0.34117648f),
	 ...
	 * 10px 0 0"></div>
	 */
	SEASHELL(1.0f, 0.9607843f, 0.93333334f),
	 ...
	 * 10px 0 0"></div>
	 */
	SIENNA(0.627451f, 0.32156864f, 0.1764706f),
	 ...
	 * 10px 0 0"></div>
	 */
	SILVER(0.7529412f, 0.7529412f, 0.7529412f),
	 ...
	 * 10px 0 0"></div>
	 */
	SKYBLUE(0.5294118f, 0.80784315f, 0.92156863f),
	 ...
	 * 10px 0 0"></div>
	 */
	SLATEBLUE(0.41568628f, 0.3529412f, 0.8039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	SLATEGRAY(0.4392157f, 0.5019608f, 0.5647059f),
	 ...
	 * 10px 0 0"></div>
	 */
	SNOW(1.0f, 0.98039216f, 0.98039216f),
	 ...
	 * 10px 0 0"></div>
	 */
	SPRINGGREEN(0.0f, 1.0f, 0.49803922f),
	 ...
	 * 10px 0 0"></div>
	 */
	STEELBLUE(0.27450982f, 0.50980395f, 0.7058824f),
	 ...
	 * 10px 0 0"></div>
	 */
	TAN(0.8235294f, 0.7058824f, 0.54901963f),
	 ...
	 * 10px 0 0"></div>
	 */
	TEAL(0.0f, 0.5019608f, 0.5019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	THISTLE(0.84705883f, 0.7490196f, 0.84705883f),
	 ...
	 * 10px 0 0"></div>
	 */
	TOMATO(1.0f, 0.3882353f, 0.2784314f),
	 ...
	 * 10px 0 0"></div>
	 */
	TURQUOISE(0.2509804f, 0.8784314f, 0.8156863f),
	 ...
	 * 10px 0 0"></div>
	 */
	VIOLET(0.93333334f, 0.50980395f, 0.93333334f),
	 ...
	 * 10px 0 0"></div>
	 */
	WHEAT(0.9607843f, 0.87058824f, 0.7019608f),
	 ...
	 * 10px 0 0"></div>
	 */
	WHITESMOKE(0.9607843f, 0.9607843f, 0.9607843f),
	 ...
	 * 10px 0 0"></div>
	 */
	YELLOWGREEN(0.6039216f, 0.8039216f, 0.19607843f);

	/**
	 * Variables for the red, green, and blue (RGB) values that specify the color
	 */
	public double r, g, b;

	/**
	 * Private constructor of the RGB values for each of the enumerated colors
	 * 
	 * @param r red value
	 * @param g green value
	 * @param b blue value
	 */
	private ColorEnum(double r, double g, double b)
	{
		this.r = r;
		this.g = g;
		this.b = b;
