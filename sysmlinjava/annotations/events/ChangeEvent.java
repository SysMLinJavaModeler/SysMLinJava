...
/**
 * Indicates that the field that follows represents a SysML "change event"
 * property, i.e. an instance of an extension of the {@code SysMLChangeEvent}
 * within the context of the current {@code SysMLBlock}. Instances of the
 * {@code SysMLChangeEvent} are typically created dynamically, as the event
