 ...
 * effectiveness. The field variable should be of a {@code SysMLValueType} (one
 * of many, perhaps) that specifies a value for some measure of effectiveness,
 * i.e the SysML "moe".
 * 
 * @author ModelerOne
 *
...
@Retention(SOURCE)
@Target({FIELD})
public @interface RequirementEffectiveness
{
	/**
